...
export const projects: Project[] = [
  {
    ...
    icon: '💬',
    logo: '/image projet/nova/logo.webp',
    images: [
      '/image projet/nova/nova accueil.webp',
      '/image projet/nova/nova messagerie.webp',
      '/image projet/nova/nova.webp',
    ],
  ...
  },
  {
    ...
    icon: '🛍️',
    logo: '/image projet/jada/logo.webp',
    images: [
      '/image projet/jada/jada.webp',
      '/image projet/jada/jada2.webp',
      '/image projet/jada/jada3.webp',
      '/image projet/jada/jada 4.webp',
    ],
  ...
  },
  {
    ...
    icon: '🏢',
    logo: '/image projet/legacy/logo.webp',
    images: [
      '/image projet/legacy/legacy accueille.webp',
      '/image projet/legacy/legacy nos esapces.webp',
      '/image projet/legacy/legacy nos espaces 2.webp',
      '/image projet/legacy/legacy nos espaces 3.webp',
      '/image projet/legacy/legacy nos services.webp',
      '/image projet/legacy/legacy reserver.webp',
      '/image projet/legacy/legacy tarif.webp',
      '/image projet/legacy/legacy compte.webp',
      '/image projet/legacy/legacy contact.webp',
      '/image projet/legacy/legacy avis.webp',
    ],
  ...
  },
  {
    ...
    icon: '🎟️',
    logo: '/image projet/billeterie/logo.webp',
    images: [
      '/image projet/billeterie/billeterie.webp',
      '/image projet/billeterie/billeterie 2.webp',
      '/image projet/billeterie/billeterie 3.webp',
      '/image projet/billeterie/billeterie 4.webp',
    ],
  ...
  },
  {
    ...
    icon: '📺',
    logo: '/image projet/job day/logo.webp',
    images: [
      '/image projet/job day/job day accueil.webp',
      '/image projet/job day/job day.webp',
      '/image projet/job day/job day 2.webp',
      '/image projet/job day/job day 3.webp',
    ],
